...
def menu():
    ...
    tick=tickets()
    print
    print("WELCOME TO KARTHIKEYA AGENCY".center(80))  
    while True:
            print
            print("="*80)
            ...
            print
            print("\t\t\t6. QUIT.")
            print("**To be displayed on client side......")
            ch=int(raw_input("ENTER YOUR CHOICE : "))
            #os.system('cls')
            print("LOADING. . from Railway Server".center(80))
            time.sleep(1)
            print ("."),
            time.sleep(0.5)
            print (".")
            ...
            if ch==1:
                j="pass"
		print("**To be displayed on client side......")
                r=raw_input("ENTER THE PASSWORD: ".center(80))
                #os.system('cls')
                if (j==r):
                    x='y'
                    while (x.lower()=='y'):
                        fout=open("tr1details.dat","ab")
			#fout=open("tr1details.txt","ab")
                        tr.getinput()
                        dump(tr,fout)
                        fout.close()
                        print("UPDATING TRAIN LIST PLEASE WAIT . .".center(80))
                        time.sleep(1)
                        print ("."),
                        time.sleep(0.5)
                        print ("."),
		...
		if not fin:
                ...
                print("="*80)
                print("CANCELLATION OF TICKETS".center(80))
                print
                print("="*80)
                print
                tick.cancellation()
